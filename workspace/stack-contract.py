...
DEFAULT_PATHS = (
    ...
    "../libraries/lib_json/include/p101_json/json.h",
    "../libraries/lib_tool_support/include/p101_tool_support/diagnostic.h",
    "../libraries/lib_tool_support/include/p101_tool_support/lesson_catalog.h",
    "../libraries/lib_tool_support/include/p101_tool_support/receipt.h",
    "../libraries/lib_tool_support/include/p101_tool_support/report.h",
    "../programs/p101-inspect/src/rule_catalog.inc",
    "../libraries/lib_subprocess/include/p101_subprocess/tool_run.h",
    "../libraries/lib_c_facts/test/test_analysis.c",
    "../libraries/lib_env/test/test_env.c",
    "../libraries/lib_fsm/test/test_fsm.c",
    "../libraries/lib_subprocess/test/test_subprocess.c",
    "../libraries/lib_tool_event/test/test_event_protocol.c",
    "../libraries/lib_tool_event/test/test_health.c",
    "../libraries/lib_tool_event/test/test_lifecycle.c",
    "../libraries/lib_tool_support/test/test_receipt.c",
    "../libraries/lib_tool_support/test/test_receipt_cli.sh",
    "../programs/p101-audit/test.sh",
    "../programs/p101-audit/test-components.sh",
    ...
    "../programs/p101-audit/components/workspace/src/boundaries.c",
    ...
    "../programs/p101-test/test-components.sh",
