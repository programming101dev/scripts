...
process_flags()
{
    ...
    if [ -d "../examples/flags/${compiler}" ]; then
        rm -f "../examples/flags/${compiler}/warning_flags.txt" "../examples/flags/${compiler}/debug_flags.txt" "../examples/flags/${compiler}/analyzer_flags.txt" "../examples/flags/${compiler}/sanitizer_flags.txt"
    else
        mkdir -p "../examples/flags/${compiler}"
    fi
    ...
    echo "$supported_flags" > "../examples/flags/${compiler}/warning_flags.txt"
    ...
    echo "$supported_flags" > "../examples/flags/${compiler}/debug_flags.txt"
    ...
    echo "$supported_flags" > "../examples/flags/${compiler}/analyzer_flags.txt"
