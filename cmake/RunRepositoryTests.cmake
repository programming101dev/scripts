...
function (_p101_run_test_tree source_directory binary_directory label)
    ...
    if (DEFINED C_COMPILER_ARG1 AND NOT "${C_COMPILER_ARG1}" STREQUAL "")
        list(APPEND _configure "-DCMAKE_C_COMPILER_ARG1=${C_COMPILER_ARG1}")
    endif ()
    if (DEFINED CXX_COMPILER_ARG1 AND NOT "${CXX_COMPILER_ARG1}" STREQUAL "")
        list(APPEND _configure "-DCMAKE_CXX_COMPILER_ARG1=${CXX_COMPILER_ARG1}")
    endif ()
